...
var buildCmd = &cobra.Command{
	Use:     "build [OPTIONS] [APP...]",
	Short:   "Runs the build lifecycle task",
	Aliases: []string{"b"},
	Long: `Runs the build lifecycle task. If no APP is provided, it will run
the default build task and the before and after build tasks if they exist.
